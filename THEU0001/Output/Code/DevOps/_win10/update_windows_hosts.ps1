...
Write-Host 'reading WSL2 ip address from: \\wsl$\ubuntu-2010-wsl\home\theundebruijn\Everything\THEU0001\Output\Code\DevOps\_tmp\ip_addr.txt'

$my_ip = Get-Content \\wsl$\ubuntu-2010-wsl\home\theundebruijn\Everything\THEU0001\Output\Code\DevOps\_tmp\ip_addr.txt -totalcount 1
