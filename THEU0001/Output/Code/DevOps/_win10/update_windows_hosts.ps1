...
Write-Host 'reading WSL2 ip address from: "\\wsl$\wsl-theundebruijn\home\theundebruijn\Work\Theun de Bruijn\Everything\THEU0001\Output\Code\DevOps\_tmp\ip_addr.txt"'

$my_ip = Get-Content "\\wsl$\wsl-theundebruijn\home\theundebruijn\Work\Theun de Bruijn\Everything\THEU0001\Output\Code\DevOps\_tmp\ip_addr.txt" -totalcount 1
