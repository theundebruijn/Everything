...
class Home extends HTMLElement  {
  ...
  createComponentInstances(fCB) {
    ...
    async.series([
      function (fCB) {  this.oComponentInstances['_header'] = new Header(fCB); }.bind(this),
    ...
    //   // order is important! even with z-indexes
      DOM.append(this.oComponentInstances['_header'], this.shadow);
  ...
  intro() {
    ...
    async.parallel([
      function (fCB) { this.oComponentInstances['_header'].intro(fCB, 0.00); }.bind(this),
  ...
  outro(fCB) {
    ...
    async.parallel([
      function (fCB) { this.oComponentInstances['_header'].outro(fCB); }.bind(this),
...
customElements.define('theu0000-pages-home', Home);
